                ...
                <div className="relative font-[sans-serif] w-max mx-auto group">
                  ...
                  <ul id="dropdownMenu" className="absolute hidden group-hover:block shadow-lg bg-white py-2 z-[1000] min-w-full w-max rounded max-h-96 overflow-auto">
                    <NavLink to="/absolute/STV"
                      className={`block text-gray-800 hover:bg-indigo-600 hover:text-white rounded-md px-4 py-2 transition duration-150 ease-in-out ${isActive('/absolute/STV') && 'bg-indigo-300 text-white'}`}>
                      Absolute
                    </NavLink>
                    <NavLink to="/ally"
                      className={`block text-gray-800 hover:bg-indigo-600 hover:text-white rounded-md px-4 py-2 transition duration-150 ease-in-out ${isActive('/ally') && 'bg-indigo-300 text-white'}`}>
                      Ally
                    </NavLink>
                  </ul>
