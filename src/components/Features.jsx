    ...
    <section className="py-20">
          <div className="container mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-9">
                  <div className="bg-white shadow-lg rounded-lg p-8 ml-5 hover:bg-gray-200">
                  ...
                  <div className="bg-white shadow-lg rounded-lg p-8 hover:bg-gray-200">
                  ...
                  <div className="bg-white shadow-lg rounded-lg p-8 mr-5 hover:bg-gray-200">
